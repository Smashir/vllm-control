...
if [[ -f "$ENV_FILE" ]]; then
    ...
    grep -E '^(MODEL_PATH|PORT|DTYPE|QUANTIZATION|KV_CACHE_DTYPE|MAX_MODEL_LEN|GPU_MEMORY_UTILIZATION|MAX_NUM_SEQS|TIKTOKEN_ENCODINGS_BASE|VLLM_ENV|VLLM_WORKDIR|VLLM_PYTHON|EXTRA_ARGS)' "$ENV_FILE"
